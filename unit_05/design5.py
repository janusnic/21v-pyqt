...
# Form implementation generated from reading ui file 'notepad5.ui'
#
# Created: Wed Dec  9 15:02:25 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fontbar = QtGui.QToolBar(MainWindow)
        self.fontbar.setObjectName(_fromUtf8("fontbar"))
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.fontbar)
        ...
        self.toolbarAction = QtGui.QAction(MainWindow)
        self.toolbarAction.setObjectName(_fromUtf8("toolbarAction"))
        self.formatbarAction = QtGui.QAction(MainWindow)
        self.formatbarAction.setObjectName(_fromUtf8("formatbarAction"))
        self.fontbarAction = QtGui.QAction(MainWindow)
        self.fontbarAction.setObjectName(_fromUtf8("fontbarAction"))
        self.statusbarAction = QtGui.QAction(MainWindow)
        self.statusbarAction.setObjectName(_fromUtf8("statusbarAction"))
        ...
        self.menuView.addAction(self.toolbarAction)
        self.menuView.addAction(self.formatbarAction)
        self.menuView.addAction(self.fontbarAction)
        self.menuView.addAction(self.statusbarAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fontbar.setWindowTitle(_translate("MainWindow", "toolBar", None))
        ...
        self.toolbarAction.setText(_translate("MainWindow", "Toggle Toolbar", None))
        self.formatbarAction.setText(_translate("MainWindow", "Toggle Formatbar", None))
        self.fontbarAction.setText(_translate("MainWindow", "Toggle Fontsbar", None))
        self.statusbarAction.setText(_translate("MainWindow", "Toggle Statusbar", None))
